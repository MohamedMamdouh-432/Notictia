    ...
    getNotes(noteTitle)
        .then((data) => {
            data.forEach((note) => {
                ...
                cell4.innerHTML = `<a onclick="openEditModal('${note['title']}')" href="#"><img src="images/edit.png" style="width: 22px;"></a>
                            <a onclick="confirmDeleteNote('${note['title']}')" href="#"><img src="images/delete.png" style="width: 22px;"></a>`
            })
        })
        .then(() => {
            if (noteId) {
